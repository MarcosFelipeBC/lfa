...
class Screen:
    ...
    def initialWindow(self):
        ...
        tk.Label(self.root, text="Digite a cadeia a ser consumida", bg='white', font="Verdana 16 bold", pady=10).pack()
    ...
    def endConsumption(self):
        ...
        self.partialAutomata = PartialAutomata(self.automata)
        self.getPng("./resources/automata.dot.svg")
        self.initialWindow()
    ...
    def processingWindow(self, chain, position):
        ...
        label = tk.Label(self.root, text=f"Cadeia: \"{chain}\" | Símbolo: {chain[position]} | Posição: {position}", bg='white', font="Verdana 20 bold", justify=tk.CENTER)
